...
// import airdrop from "../../public/contracts/Airdrop.json";
...
export const contractAddress = (contract as any)["networks"][targetNetwork]["address"];
export const pinataApiKey = process.env.PINATA_API_KEY as string;
export const pinataSecretApiKey = process.env.PINATA_SECRET_API_KEY as string;
// 代币hash
export const ERC20_Token_Address= '0x9b32f5F022B3A3fBC7DD4aef2f3E5867A0C5796C';
// 代币空投地址可以用mint地址
export const ERC20_AIRDROP_TOKEN = '0xB38d2D30e1f854C608117aEA7694c52c73929FC7';
